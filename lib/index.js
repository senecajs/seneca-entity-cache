...
module.exports = function (options) {
  ...
  var load = function (args, callback) {
    ...
    upstream.get({ key: vkey }, function (err, version) {
      ...
      if (version === undefined ||
        ...
        return prior(args, function (err, ent) {
          ...
          writeKey(vkey, function (err) {
            ...
            return writeData(ent, 0, function (err, version) {
      ...
      upstream.get({ key: key }, function (err, ent) {
  ...
  var remove = function (args, callback) {
    ...
    this.prior(args, function (err, ent) {
      ...
      upstream.set({ key: vkey, val: -1, expires: settings.expires }, function (err, ent) {
